...
var DropdownComponent = ({
  ...
  const handleSelect = (0, import_react27.useCallback)((index2) => {
...
var MegaMenuDropdown = ({
  ...
  const [labelledBy, setLabelledBy] = (0, import_react32.useState)(void 0);
...
var MegaMenuDropdownToggle = ({
  ...
  const [controls, setControls] = (0, import_react33.useState)(void 0);
  const [isExpanded, setExpanded] = (0, import_react33.useState)(void 0);
...
var ModalContext = (0, import_react34.createContext)(void 0);
...
var ModalHeader = ({
  ...
  const innerHeaderId = (0, import_react35.useId)();
...
// node_modules/flowbite-react/dist/esm/components/Modal/Modal.mjs
var ModalComponent = (0, import_react37.forwardRef)(
  ({
    children,
    className,
    dismissible = false,
    ...
    const [headerId, setHeaderId] = (0, import_react37.useState)(void 0);
...
function Popover({
  ...
  const [uncontrolledOpen, setUncontrolledOpen] = (0, import_react39.useState)(Boolean(initialOpen));
  ...
  if (!(0, import_react39.isValidElement)(children)) {
...
var RangeSlider = (0, import_react42.forwardRef)(
...
var RatingContext = (0, import_react43.createContext)(void 0);
function useRatingContext() {
  const context = (0, import_react43.useContext)(RatingContext);
  if (!context) {
...
var SidebarContext = (0, import_react47.createContext)(void 0);
...
var SidebarItemContext = (0, import_react48.createContext)(void 0);
function useSidebarItemContext() {
  const context = (0, import_react48.useContext)(SidebarItemContext);
  if (!context) {
...
var SidebarCollapse = ({
  ...
  const [isOpen, setOpen] = (0, import_react49.useState)(open);
  const { theme: rootTheme, isCollapsed } = useSidebarContext();
  const theme2 = mergeDeep(rootTheme.collapse, customTheme);
  (0, import_react49.useEffect)(() => setOpen(open), [open]);
...
var SidebarItem = (0, import_react50.forwardRef)(
  ({
    active: isActive,
    as: Component = "a",
    children,
...
var TableBodyContext = (0, import_react52.createContext)(void 0);
...
var TableContext = (0, import_react53.createContext)(void 0);
function useTableContext() {
  const context = (0, import_react53.useContext)(TableContext);
  if (!context) {
...
// node_modules/flowbite-react/dist/esm/components/Table/TableBody.mjs
var TableBody = (0, import_react54.forwardRef)(
...
var TableCell = (0, import_react55.forwardRef)(
  ({ children, className, theme: customTheme = {}, ...props }, ref) => {
...
var TableHeadContext = (0, import_react56.createContext)(void 0);
function useTableHeadContext() {
  const context = (0, import_react56.useContext)(TableHeadContext);
  if (!context) {
...
// node_modules/flowbite-react/dist/esm/components/Table/TableHead.mjs
var TableHead = (0, import_react57.forwardRef)(
  ({ children, className, theme: customTheme = {}, ...props }, ref) => {
    const { theme: rootTheme } = useTableContext();
...
var TableHeadCell = (0, import_react58.forwardRef)(
  ({ children, className, theme: customTheme = {}, ...props }, ref) => {
...
// node_modules/flowbite-react/dist/esm/components/Table/Table.mjs
var TableComponent = (0, import_react60.forwardRef)(
...
var TabsComponent = (0, import_react61.forwardRef)(
  ({ children, className, onActiveTabChange, style = "default", theme: customTheme = {}, ...props }, ref) => {
    ...
    const tabs = (0, import_react61.useMemo)(
      () => import_react61.Children.map(
        import_react61.Children.toArray(children),
        ({ props: props2 }) => props2
      ),
      [children]
    );
    const tabRefs = (0, import_react61.useRef)([]);
    const [activeTab, setActiveTab] = (0, import_react61.useState)(
      Math.max(
        0,
        tabs.findIndex((tab) => tab.active)
      )
    );
    const [focusedTab, setFocusedTab] = (0, import_react61.useState)(-1);
...
var TimelineContentContext = (0, import_react63.createContext)(void 0);
function useTimelineContentContext() {
  const context = (0, import_react63.useContext)(TimelineContentContext);
  if (!context) {
...
var TimelineContext = (0, import_react64.createContext)(void 0);
function useTimelineContext() {
  const context = (0, import_react64.useContext)(TimelineContext);
  if (!context) {
...
var TimelineItemContext = (0, import_react65.createContext)(void 0);
function useTimelineItemContext() {
  const context = (0, import_react65.useContext)(TimelineItemContext);
  if (!context) {
...
var ToastContext = (0, import_react66.createContext)(void 0);
function useToastContext() {
  const context = (0, import_react66.useContext)(ToastContext);
  if (!context) {
...
var ToastComponent = ({ children, className, duration = 300, theme: customTheme = {}, ...props }) => {
  const [isClosed, setIsClosed] = (0, import_react67.useState)(false);
  const [isRemoved, setIsRemoved] = (0, import_react67.useState)(false);
...
var ToggleSwitch = (0, import_react68.forwardRef)(
  ({
    checked,
    className,
    color = "blue",
